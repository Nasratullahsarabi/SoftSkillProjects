...
public class LibrarianAddBook extends TestBase {
 ...
 //   Given librarian is on the homePage
    ...
    public void librarianAddBook() throws InterruptedException {
        ...
        for (String eachUser : users) {
            ...
            Thread.sleep(6000);
            System.out.println("driver.findElement(By.xpath(\"//div[@id='tbl_books_info']\")).getText() = " + driver.findElement(By.xpath("//div[@id='tbl_books_info']")).getText());
            Thread.sleep(1000);
